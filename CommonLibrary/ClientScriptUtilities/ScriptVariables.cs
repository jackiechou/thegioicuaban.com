...
using CommonLibrary.Ajax.JsonSerializers;

namespace CommonLibrary.ClientScriptUtilities
{
    /// <summary>
    ...
    public class ScriptVariables
    {
        ...
        public ScriptVariables(Control control, string clientObjectName)
        {
            ...
            JsonSerializer = new JSONSerializer(SupportedJsonParserTypes.CustomJsonSerializer);
        ...
        public TType GetValue<TType>(string key)
        {
            ...
            textValue = UrlUtils.GetUrlEncodedKey(textValue, key);
            if (textValue == null)
                return default(TType);
        ...
        public TType GetItemValue<TType>(string key)
        {
            ...
            textValue = UrlUtils.GetUrlEncodedKey(textValue, "_Items");
            if (string.IsNullOrEmpty(textValue))
                return default(TType);

...
namespace CommonLibrary.UI.Skins
{
    public class NavObjectBase : SkinObjectBase
    {
        ...
        private System.Collections.Generic.List<CustomAttribute> m_objCustomAttributes = new System.Collections.Generic.List<CustomAttribute>();
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), PersistenceMode(PersistenceMode.InnerProperty)]
        public System.Collections.Generic.List<CustomAttribute> CustomAttributes
        {
        ...
        {
            get { return m_intExpandDepth; }
            set { m_intExpandDepth = value; }
        }
        public int StartTabId
        {
            get { return m_intStartTabId; }
            set { m_intStartTabId = value; }
        }
        ...
        private void AssignControlProperties()
        {
            ...
            Control.CustomAttributes = this.CustomAttributes;
        }
        ...
        private string GetPath(string strPath)
        {
            ...
            {
                return strPath.Replace("[APPIMAGEPATH]", Common.Globals.ApplicationPath + "/images/");
            }

...
namespace CommonLibrary.UI.ControlPanels
{
    public class ControlPanelBase : System.Web.UI.UserControl
    {
        ...
        {
            Personalization.SetProfile("Usability", "UserMode" + PortalSettings.PortalId.ToString(), userMode.ToUpper());
        }
        protected void SetVisibleMode(bool isVisible)
        {
            Personalization.SetProfile("Usability", "ControlPanelVisible" + PortalSettings.PortalId.ToString(), isVisible.ToString());
        }

...
namespace CommonLibrary.Services.Log.EventLog
{
    ...
    public class LogInfoArray : IEnumerable, IList
    {
        ...
        {
            get { return arrLogs.IsSynchronized; }
        }
        public object SyncRoot
        {
            get { return arrLogs.SyncRoot; }
        }
        public void Clear()
        {
            arrLogs.Clear();
        ...
        {
            get { return arrLogs.IsFixedSize; }
        }
        public bool IsReadOnly
        {
            get { return arrLogs.IsReadOnly; }
        }
        public object this[int index]
        {
            get { return arrLogs[index]; }
            set { arrLogs[index] = value; }
        }

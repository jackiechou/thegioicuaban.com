...
namespace CommonLibrary.Data.Linq
{
    ...
    public static class DataContractSerializationUtils
    {
        ...
        /// <returns></returns>
        public static string SerializeToXmlString(object value, bool throwExceptions = false)
        {
        ...
        /// <param name="throwExceptions"></param>
        /// <returns></returns>
        public static byte[] SerializeToBinary(object value, bool throwExceptions = false)
        {
        ...
        /// <returns></returns>
        public static bool SerializeToStream(object value, Stream stream, bool binary = false, bool throwExceptions = false)
        {
            DataContractSerializer ser = new DataContractSerializer(value.GetType());
        ...
        /// <returns></returns>
        public static object DeserializeXmlString(string xml, Type type, bool throwExceptions = false)
        {
        ...
        /// <param name="throwExceptions"></param>
        /// <returns></returns>
        public static object DeserializeBinary(byte[] data, Type type, bool throwExceptions = false)
        {
        ...
        /// <param name="type"></param>
        public static object DeserializeStream(Stream stream, Type type, bool binary = false, bool throwExceptions = false)
        {

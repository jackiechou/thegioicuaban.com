...
namespace CommonLibrary.Data.Linq.Pagination
{
    ...
    public static class PagingExtensions
    {
        ...
        public static IQueryable<T> Paginate<T>(this IQueryable<T> query, int page, int pageSize)
        {
            ...
            return query.Skip(skip).Take(pageSize).Cast<T>();
        }
        ...
        //public static PagedList<T> ToPagedList<T>(this IEnumerable<T> source, int pageIndex, int pageSize, string identityColumnName)
        //{
        //    return new PagedList<T>(source, pageIndex, pageSize, identityColumnName);
        //}

        //public static PagedList<T> ToPagedList<T>(this IEnumerable<T> source, int pageIndex, int pageSize, string identityColumnName, string sortExpression)
        //{
        //    return new PagedList<T>(source, pageIndex, pageSize, identityColumnName, sortExpression);
        //}
        #endregion

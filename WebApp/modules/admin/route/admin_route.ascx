<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="admin_route.ascx.cs" Inherits="WebApp.modules.admin.route.admin_route" %>
...
<div class="wrap_gp">
    ...
    <div class="group_commands">
        ...
        <div class="right">
            <div class="fillter_tool">
                Chọn Portal &nbsp;<asp:DropDownList ID="ddlPortalList" runat="server" onselectedindexchanged="ddlPortalList_SelectedIndexChanged">
                                </asp:DropDownList>
                Chọng Content Item &nbsp; <asp:DropDownList ID="ddlContentItem" runat="server" 
                    CssClass="combobox" Width="100px" 
                    onselectedindexchanged="ddlContentItem_SelectedIndexChanged">
                                    </asp:DropDownList>
                Chọng Ngôn Ngữ&nbsp;<asp:DropDownList ID="ddlCultureList" runat="server" 
                    CssClass="combobox" 
                    onselectedindexchanged="ddlCultureList_SelectedIndexChanged" >
                </asp:DropDownList>                
                &nbsp; Status:
    ...
    <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
        ...
        <ContentTemplate>
            <asp:GridView ID="GridView1" DataKeyNames="RouteId" runat="server" 
                ...
                <Columns>
                    <asp:TemplateField HeaderText="x">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtIdx" runat="server" Text='<%# Bind("RouteId") %>' Width="30px"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:CheckBox ID="chkBxSelect" runat="server" />
                            <asp:HiddenField ID="hdnFldId" runat="server" Value='<%# Eval("RouteId") %>' />
                        </ItemTemplate>
                        <HeaderTemplate>
                    ...
                    <asp:BoundField DataField="RouteUrl" HeaderText="RouteUrl" />                    
                    <asp:BoundField DataField="PhysicalFile" HeaderText="PhysicalFile" />
                    <asp:BoundField DataField="RouteValueDictionary" HeaderText="RouteValueDictionary" />
                    <asp:TemplateField HeaderText="CheckPhysicalUrlAccess">                           
                        <ItemTemplate>
                            <asp:CheckBox ID="chkCheckPhysicalUrlAccess" runat="server" Checked='<%# Eval("CheckPhysicalUrlAccess")%>' 
                                Text='<%# Eval("CheckPhysicalUrlAccess").ToString().Equals("True") ? " Yes " : " No " %>'
                                Enabled="false" />
                        </ItemTemplate>
                    </asp:TemplateField>               
                    <asp:TemplateField HeaderText="Discontinued">                           
                        <ItemTemplate>
                            <asp:Label ID="lblDiscontinued" runat="server"
                                Text='<%# Eval("Discontinued").ToString().Equals("True") ? " Active " : " InActive " %>'
                                Enabled="false" />
                        </ItemTemplate>
                    </asp:TemplateField>                  
                </Columns>

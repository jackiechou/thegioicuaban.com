<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_skin_packages_edit.aspx.cs" Inherits="WebApp.modules.admin.ui.admin_skin_packages_edit" %>
...
<head id="Head1" runat="server">
   ...
   <script language="javascript" type="text/javascript">
       function getbacktostepone() {
           window.location = "modules/admin/ui/admin_skin_packages_edit.aspx";
       }
       function onSuccess() {
    ...
    <div class="popup_Container">
        <div class="popup_Titlebar" id="PopupHeader">
            <div class="TitlebarLeft">
                Quản lý Skin Package: Cập Nhập Thông Tin</div>
                        ...
                        <tr>
                         ...
                         <tr>
                             <td align="left" style="width:150px">
                                 * Tên Skin</td>
                             <td align="left">
                                 <asp:TextBox ID="txtSkinName" runat="server" Width="300px"></asp:TextBox>
                                 &nbsp;&nbsp;<asp:RequiredFieldValidator ID="rfvNewTitle" runat="server" 
                                     ControlToValidate="txtSkinName" ErrorMessage="*" SetFocusOnError="True" 

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_skins_edit.aspx.cs" Inherits="WebApp.modules.admin.ui.admin_skins_edit" %>
...
<head id="Head1" runat="server">
   ...
   <script language="javascript" type="text/javascript">
       function getbacktostepone() {
           window.location = "modules/admin/ui/admin_skins_edit.aspx";
       }
       function onSuccess() {
    ...
    <div class="popup_Container">
        <div class="popup_Titlebar" id="PopupHeader">
            <div class="TitlebarLeft">
                Quản lý Skins: Cập Nhập Thông Tin</div>
                       ...
                       <tr>
                         ...
                         <tr>
                             <td align="left" style="width:150px">
                                 * SkinSrc</td>
                             <td align="left">                                
                                 <asp:TextBox ID="txtControlSrc" runat="server" Visible="False"></asp:TextBox>

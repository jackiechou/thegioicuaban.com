<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_skin_controls_edit.aspx.cs" Inherits="WebApp.modules.admin.ui.admin_skin_controls_edit" %>
...
<head id="Head1" runat="server">
   ...
   <script language="javascript" type="text/javascript">
       function getbacktostepone() {
           window.location = "modules/admin/ui/admin_skin_controls_edit.aspx";
       }
       function onSuccess() {
    ...
    <div class="popup_Container">
        <div class="popup_Titlebar" id="PopupHeader">
            <div class="TitlebarLeft">
                Quản lý Skin Controls: Cập Nhập Thông Tin</div>
                    ...
                    <table border="0" cellspacing="0" cellpadding="4"> 
                        ...
                        <tr>
                            <td align="left" style="width:150px">
                                * ControlKey</td>
                            <td align="left">                                
                                 <asp:TextBox ID="txtControlKey" runat="server"></asp:TextBox>                                
                            </td>
                        </tr>     
                         ...
                         <tr>
                             <td align="left" style="width:150px">
                                 * ControlSrc</td>
                             <td align="left">
                                <asp:TextBox ID="txtControlSrc" Visible="false" runat="server"></asp:TextBox>
                                <input id="inputFileControlSrc" type="file" />
                             </td>
                         </tr>

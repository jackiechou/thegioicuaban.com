<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="admin_skin_controls.ascx.cs" Inherits="WebApp.modules.admin.ui.admin_skin_controls" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
 ...
 <script type="text/javascript">
  ...
  <script language="javascript" type="text/javascript">
      var add_path = "/modules/admin/ui/admin_skin_controls_edit.aspx?mode=add";
      var edit_path = "/modules/admin/ui/admin_skin_controls_edit.aspx?mode=edit&idx=";
...
<div class="wrap_gp" >      
    <div class="commontool">
        <h3>QUẢN LÝ HỆ THỐNG SKIN CONTROL</h3>
        <div class="toolbar">          
    ...
    <div class="group_panel">   
        <asp:GridView ID="GridView1" runat="server" DataKeyNames="SkinControlId" 
        ...
        <Columns>
            ...
            <EditItemTemplate>                                         
                <asp:TextBox ID="txtIdx" runat="server" Text='<%# Bind("SkinControlId") %>' Width="30px"></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
                <asp:CheckBox ID="chkBxSelect" runat="server" />
                <asp:HiddenField ID="hdnFldId" runat="server" Value='<%# Eval("SkinControlId") %>' />
            </ItemTemplate>
            <HeaderTemplate>
            ...
            <asp:BoundField DataField="SkinControlId" HeaderText="SkinControlId" SortExpression="SkinControlId" />
            <asp:BoundField DataField="SkinPackageId" HeaderText="SkinPackageId" SortExpression="SkinPackageId" />  
            <asp:BoundField DataField="ControlKey" HeaderText="Title" SortExpression="ControlKey" />    
            <asp:BoundField DataField="ControlSrc" HeaderText="Title" SortExpression="ControlSrc" /> 
            <asp:TemplateField HeaderText="IconFile">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Eval("IconFile") %>'></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Image ID="Image1" runat="server" Width="50px" Height="50px" 
                        ImageUrl='<%# Eval("IconFile", "~/user_files/images/skin_images/{0}") %>' />
                </ItemTemplate>
            </asp:TemplateField>                          
        </Columns>

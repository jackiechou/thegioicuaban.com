<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="admin_skins.ascx.cs" Inherits="WebApp.modules.admin.ui.admin_skins" %>
 ...
 <script type="text/javascript">
  ...
  <script language="javascript" type="text/javascript">
      function ShowAddModal() {
          ...
          frame.src = "modules/admin/ui/admin_skins_edit.aspx?mode=add";
      ...
      function ShowModalEdit() {
          ...
          if (SelectedValues != '') {
              if (SelectedItems.length == 1) {
                  var edit_path = "modules/admin/ui/admin_skins_edit.aspx?mode=edit&idx=";
...
<div class="wrap_gp" >      
    ...
    <div class="group_panel">   
        <asp:GridView ID="GridView1" runat="server" DataKeyNames="Skin_ID" Width="100%" Height="100%"  PageSize="30" 
        ...
        <Columns>
            ...
            <EditItemTemplate>                                         
                <asp:TextBox ID="txtIdx" runat="server" Text='<%# Bind("Skin_ID") %>' Width="30px"></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
                <asp:CheckBox ID="chkBxSelect" runat="server" />
                <asp:HiddenField ID="hdnFldId" runat="server" Value='<%# Eval("Skin_ID") %>' />
            </ItemTemplate>
            <HeaderTemplate>
            ...
            <asp:BoundField DataField="Skin_ID" HeaderText="Skin_ID" InsertVisible="False" 
                ReadOnly="True" SortExpression="Skin_ID" />
            <asp:BoundField DataField="SkinPackage_ID" HeaderText="SkinPackage_ID" SortExpression="SkinPackage_ID" />  
            <asp:BoundField DataField="SkinName" HeaderText="SkinSrc" SortExpression="SkinName" />           
            <asp:BoundField DataField="SkinSrc" HeaderText="SkinSrc" SortExpression="SkinSrc" />   
        </Columns>

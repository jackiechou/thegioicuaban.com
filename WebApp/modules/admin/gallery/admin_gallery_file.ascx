<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="admin_gallery_file.ascx.cs" Inherits="WebApp.modules.admin.gallery.admin_gallery_file" %>
<script type="text/javascript">
    ...
    //========================================================================================================
    //Change background color on gridview on mouse over and mouse out     
    var lastColorUsed;
    function setMouseOverColor(row) {
        lastColorUsed = row.style.backgroundColor;
        row.style.backgroundColor = '#BAD5E8';
        row.style.cursor = 'hand';
        row.style.textDecoration = 'underline';
    }

    function setMouseOutColor(row) {
...
<div id="DivAddWindow" style="display: none;" class="popupConfirmation">
    <iframe id="IframeAdd" frameborder="0" height="600" width="750" scrolling="no"></iframe>
</div>
...
<div id="DivEditWindow" style="display: none;" class="popupConfirmation">
    <iframe id="IframeEdit" frameborder="0" height="650" width="750" scrolling="no">
    </iframe>
</div>  
<div class="wrap_gp" >  
            ...
            <div class="group_commands">       
                ...
                <div class="right">
                    <div  class="fillter_tool">                                               
                        Gallery Topic:   
                        <asp:DropDownList ID="ddlTreeNode_Topics" AutoPostBack="true" runat="server" 
                                onselectedindexchanged="ddlTreeNode_Topics_SelectedIndexChanged"></asp:DropDownList>                          
                        &nbsp; Collection:                                   

                        <asp:DropDownList ID="ddlCollection" AutoPostBack="true" runat="server" 
                            onselectedindexchanged="ddlCollection_SelectedIndexChanged" Height="17px" 
                            Width="218px"></asp:DropDownList>                          
                        &nbsp; Status:     

                        <asp:DropDownList ID="ddlStatus" runat="server" onselectedindexchanged="ddlStatus_SelectedIndexChanged"></asp:DropDownList>  
                  
                        &nbsp;<asp:ImageButton ID="btnSearch" runat="server" BorderWidth="0" BorderStyle="None" 
            ...
            <div class="group_panel">
                    <asp:GridView ID="GridView1" DataKeyNames="FileId" runat="server"  

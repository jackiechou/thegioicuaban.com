<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="admin_gallery_collection.ascx.cs" Inherits="WebApp.modules.admin.gallery.admin_gallery_collection" %>
...
<div class="wrap_gp" > 
    <div class="commontool">
        <h3>Quản lý Gallery Collection</h3>
        <div class="toolbar">          
    ...
    <div style="clear:both;"></div> 
     ...
     <asp:UpdatePanel ID="UpdatePanel1" EnableViewState="true" UpdateMode="Conditional" runat="server">
            <Triggers>
                <asp:PostBackTrigger ControlID="ddlTreeNode_Topics" />
                <asp:PostBackTrigger ControlID="ddlStatus" />
            </Triggers>
            <ContentTemplate>  
          <asp:GridView ID="GridView1" DataKeyNames="CollectionId" runat="server"  
            ...
            <Columns>
                 <asp:TemplateField HeaderText="x">
                            <EditItemTemplate>                                         
                                <asp:TextBox ID="txtIdx" runat="server" Text='<%# Bind("CollectionId") %>' Width="30px"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:CheckBox ID="chkBxSelect" runat="server" />
                                <asp:HyperLink ID="hplGetRowSelected" runat="server">Chọn</asp:HyperLink>
                                <asp:HiddenField ID="hdnFldAlias" runat="server" Value='<%# Eval("Title") %>' />
                                <asp:HiddenField ID="hdnFldId" runat="server" Value='<%# Eval("CollectionId") %>' />
                            </ItemTemplate>
                            <HeaderTemplate>

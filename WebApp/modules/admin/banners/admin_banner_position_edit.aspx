<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_banner_position_edit.aspx.cs" Inherits="WebApp.modules.admin.banners.admin_banner_position_edit" %>
...
<head id="Head1" runat="server">
   ...
   <script language="javascript" type="text/javascript">
       function getbacktostepone() {
           window.location = "modules/admin/banners/admin_banner_position_edit.aspx";
       }
       function onSuccess() {
                    ...
                    <table border="0" cellspacing="0" cellpadding="4"> 
                         <tr>
                             <td align="left" style="width:150px">
                                 * Vị trí Banner:</td>
                             <td align="left">
                                 <asp:TextBox ID="txtBannerPosition" runat="server" Width="300px"></asp:TextBox>
                                 <asp:RequiredFieldValidator ID="rfvBannerPosition" runat="server" 
                                     ControlToValidate="txtBannerPosition" ErrorMessage="*" SetFocusOnError="True" 
                         ...
                         <tr>
                            <td align="left" style="width:150px">
                                * Thứ tự (ParentId)</td>
                            <td align="left">                                
                                <asp:ListBox ID="lstTreeNode" runat="server" Rows="5" Height="200px" Width="300px" />                                                              
                            </td>
                        </tr>        

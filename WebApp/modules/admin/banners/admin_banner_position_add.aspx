<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_banner_position_add.aspx.cs" Inherits="WebApp.modules.admin.banners.admin_banner_position_add" %>
                    ...
                    <table border="0" cellspacing="0" cellpadding="4"> 
                         ...
                         <tr>
                            <td align="left" style="width:150px">
                                * Thứ tự (ParentId)</td>
                            <td align="left">                                
                                 <asp:DropDownList ID="ddlTreeNode" runat="server"></asp:DropDownList>                                                                
                            </td>
                        </tr>        

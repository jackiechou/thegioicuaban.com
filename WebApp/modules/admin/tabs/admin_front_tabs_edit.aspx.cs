...
{
    public partial class admin_front_tabs_edit : System.Web.UI.Page    
    {
        ...
        protected void ShowListInContent(string selectedvalue)
        {
            int PortalId = Convert.ToInt32(ddlPortalList.SelectedValue);
            int ContentItemId = Convert.ToInt32(ddlContentItem.SelectedValue);
            List<aspnet_Tab> lst = TabController.GetListByPortalId_ContentItemId_IsSecure(PortalId, ContentItemId, true);
            ...
            ddlListInContent.DataValueField = "TabId";
            ddlListInContent.DataBind();
            ddlListInContent.Items.Insert(0, new ListItem("", "0"));
            ddlListInContent.SelectedValue = selectedvalue;
        }   
        ...
        private void ShowListFileInFolder(string selected_value)
        {
            ...
            ddlPathFile.SelectedValue = selected_value;
        }      
        #endregion =======================================================================
        ...
        private void ShowListRouterUrl(string selected_value)
        {
            ...
            ddlRouter.DataValueField = "RouteId";
            ddlRouter.DataBind();
            ddlRouter.SelectedValue = selected_value;
        }
        #endregion ============================================================        

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_tab_module.aspx.cs" Inherits="WebApp.modules.admin.tabs.admin_tab_module" %>
...
<%----- ModalPopupExtender JavaScript -------%>                                                                                                  
 <script language="javascript" type="text/javascript">
     function getbacktostepone() {
         window.location = "admin_tab_module.aspx";
     }
     function ShowEditModal(idx) {
         ...
         var edit_path = "admin_tab_module_edit.aspx?mode=edit&idx=";
        ...
        <div class="popup_Container">
            <div class="popup_Titlebar" id="Div1">
                <div class="TitlebarLeft">
                    Danh sách Module Controllers theo Module - Tab Name :
                    <asp:Literal ID="Literal_TabName" runat="server"></asp:Literal>
                </div>
            ...
            <div class="popup_Body">  
                <div id="gp">   
                        ...
                        <div id="group_panel">           
                            ...
                            <asp:GridView ID="GridView1" runat="server" DataKeyNames="TabModuleID" 
                                ...
                                onrowcommand="GridView1_RowCommand"  >
                                    ...
                                    <Columns>      
                                        ...
                                        <EditItemTemplate>                                         
                                            <asp:TextBox ID="txtIdx" runat="server" Text='<%# Bind("TabModuleID") %>' Width="30px"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkBxSelect" runat="server" />
                                            <asp:HiddenField ID="hdnFldId" runat="server" Value='<%# Eval("TabModuleID") %>' />
                                        </ItemTemplate>
                                        <HeaderTemplate>
                                    ...
                                    <asp:BoundField DataField="TabModuleID" HeaderText="TabModuleID" />
                                    ...
                                    <asp:BoundField DataField="PaneName" HeaderText="PaneName" />                                                                                       
                                    <asp:BoundField DataField="ModuleOrder" HeaderText="ModuleOrder" />                                      
                                    <asp:BoundField DataField="TabName" HeaderText="TabName"/>
                                    <asp:TemplateField HeaderText="Edit" ShowHeader="False">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="btnEdit" runat="server" ImageUrl="~/images/icons/btnEdit.gif"

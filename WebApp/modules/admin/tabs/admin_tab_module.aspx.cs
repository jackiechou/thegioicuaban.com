...
{
    public partial class admin_tab_module : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                int TabID = Convert.ToInt32(Request.QueryString["id"]);
                Literal_TabName.Text = tab_module_obj.GetTabNameByTabId(TabID);
        ...
        private void FillDataInGrid()
        {
            ...
            DataTable dt = tab_module_obj.GetModuleByTabId(TabID);
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            //{
            //    int i = tab_module_obj.Delete(id);
            //    FillDataInGrid();
            //}
            //switch (_commandName)
            //{
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (btnEdit != null)
                {
                    btnEdit.Attributes.Add("onclick", "ShowEditModal(" + ID + ")");
                }

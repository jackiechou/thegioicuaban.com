<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="permission_tabs_add.aspx.cs" Inherits="WebApp.modules.admin.security.roles.permission_tabs_add" %>
    ...
    <title>edit</title>
        ...
        <script type="text/javascript">
            ...
            function okay() {               
                ...
                window.parent.document.getElementById('ButtonAddTabPermissionCancel').click();               
            }
            function cancel() {               
                window.parent.document.getElementById('ButtonAddTabPermissionCancel').click();
            }
                            ...
                            <td align="left" colspan="7">
                                <asp:Panel ID="Panel1" runat="server" Height="300px" ScrollBars="Vertical">
                                    <asp:GridView ID="GridView1" runat="server" AllowSorting="True" 
                                        ...
                                        CellPadding="3" DataKeyNames="TabId" EmptyDataText="No Data" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="TabName" ItemStyle-Width="350px">
                                                <ItemTemplate>

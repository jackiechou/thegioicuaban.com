<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="permission_tabs_edit.aspx.cs" Inherits="WebApp.modules.admin.security.roles.permission_tabs_edit" %>
    ...
    <title>edit</title>
        ...
        <script type="text/javascript">
            function getbacktostepone() {
                window.location = "permission_tabs_edit.aspx";
            }
            function onSuccess() {
            ...
            function okay() {              
                ...
                window.parent.document.getElementById('ButtonEditTabPermissionDone').click();     
            }
            function cancel() {             
               window.parent.document.getElementById('ButtonEditTabPermissionCancel').click();               
            }
                           ...
                           <td align="left">
                            ...
                            <td align="left">
                                <asp:DropDownList ID="ddlRoleList"  runat="server"   
                                        CssClass="combobox" Width="147px" ></asp:DropDownList></td>
                            <td align="left">
                            ...
                            <td align="left" colspan="7">
                                <asp:Panel ID="Panel1" runat="server" Height="300px" ScrollBars="Vertical">
                                    <asp:GridView ID="GridView1" runat="server" AllowPaging="False" 
                                        AllowSorting="True" AlternatingRowStyle-BackColor="#C2D69B" 
                                        AutoGenerateColumns="False" CellPadding="3" DataKeyNames="TabId" 
                                        EmptyDataText="No Data" GridLines="Both" HeaderStyle-BackColor="#8FB53D" 
                                        HeaderStyle-Font-Bold="true" Height="100%" ondatabound="GridView1_DataBound" 
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="TabId" HeaderText="TabId" ItemStyle-Width="40px" />
                                            <asp:TemplateField HeaderText="TabName" ItemStyle-Width="400px">
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txtTabName" runat="server" Text='<%# Bind("TabName") %>'></asp:TextBox>
                                                </EditItemTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTabName" runat="server" Text='<%# Bind("TabName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Selected Permission" ItemStyle-Width="100px">
                                                <EditItemTemplate>
                                                    <asp:CheckBox ID="chkPermissionRight" runat="server" Checked="false" />
                                                </EditItemTemplate>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Allow Access" ItemStyle-Width="140px">
                                                <EditItemTemplate>
                                                    <asp:CheckBox ID="chkAllowAccessRight" runat="server" />
                                                </EditItemTemplate>
                                                <ItemTemplate>

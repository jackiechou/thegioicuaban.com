<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="permission_modules_edit.aspx.cs" Inherits="WebApp.modules.admin.security.roles.permission_modules_edit" %>
    ...
    <title>edit</title>
        ...
        <script type="text/javascript">
            ...
            function okay() {
                ...
                window.parent.document.getElementById('ButtonEditModulePermissionDone').click();
            }
            function cancel() {
                window.parent.document.getElementById('ButtonEditModulePermissionCancel').click();
            }
                            ...
                            <td align="left" colspan="7">
                                <asp:Panel ID="Panel1" runat="server" Height="300px" ScrollBars="Vertical">
                                    <asp:GridView ID="GridView1" runat="server" AllowPaging="False" 
                                        ...
                                        AutoGenerateColumns="False" CellPadding="3" DataKeyNames="ModuleId" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="ModuleTitle" ItemStyle-Width="400px">
                                                <EditItemTemplate>

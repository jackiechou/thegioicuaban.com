...
{
    public partial class permission_tabs_add : System.Web.UI.Page
    {
        ...
        //protected void chkAllViewRight_CheckedChanged(object sender, EventArgs e)
        //{
        //    CheckBox chk = (CheckBox)GridView1.HeaderRow.FindControl("chkAllViewRight");
        //    if (chk.Checked)
        //    {
        //        for (int i = 0; i < GridView1.Rows.Count; i++)
        //        {
        //            CheckBox chkrow = (CheckBox)GridView1.Rows[i].FindControl("chkSelectedViewRight");
        //            chkrow.Checked = true;
        //        }

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="path_edit.ascx.cs" Inherits="WebApp.modules.admin.security.path_edit" %>
<div id="wrap_gp" class="wrap_gp" >   
    <div class="commontool">
            <h3>Quản Lý Ứng Dụng: Sửa thông tin</h3>
            <div class="toolbar">     
                 <asp:LinkButton ID="btnUpdate" runat="server" CssClass="btn" OnClick="btnUpdate_Click" ValidationGroup="ValidationCheck">
    ...
    <table border="0" cellspacing="0" cellpadding="4" class="form">
       ...
       <tr>
          <td style="width: 34px; height: 15px" align="right">&nbsp;</td>
          <td align="left" >
              * 
              Path</td>
            <td align="left" style="height: 15px">
                <asp:TextBox ID="txtPath" runat="server" Width="485px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="rfvPathe" runat="server" ErrorMessage="*" 

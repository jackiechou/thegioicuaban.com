<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aspnet_users_edit.aspx.cs" Inherits="WebApp.modules.admin.security.users.aspnet_users_edit" %>
...
<head id="Head1" runat="server">
   ...
   <script language="javascript" type="text/javascript">
       function getbacktostepone() {
           window.location = "aspnet_users_edit.aspx";
       }
       function onSuccess() {
    ...
    <script type="text/javascript">
        function checkPass() {
            ...
            var pass2 = document.getElementById('txtPasswordConfirm');

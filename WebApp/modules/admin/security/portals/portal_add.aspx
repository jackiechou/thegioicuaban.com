<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="portal_add.aspx.cs" Inherits="WebApp.modules.admin.security.portals.portal_add" %>
...
<head id="Head1" runat="server">
   ...
   <script language="javascript" type="text/javascript">
       function getbacktostepone() {
           window.location = "portal_add.aspx";
       }
       function onSuccess() {
                    ...
                    <table  border="0" cellspacing="0" cellpadding="4" class="form">
                            ...
                            <tr>
                                <td align="left">
                                    * HomeDirectory</td>
                                <td align="left">
                                    <asp:TextBox ID="txtHomeDirectory" runat="server" Width="300px"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    FooterText</td>
                                <td align="left">
                                    <asp:TextBox ID="txtFooterText" runat="server" TextMode="MultiLine" 

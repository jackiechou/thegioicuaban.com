<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_background_audio_edit.aspx.cs" Inherits="WebApp.modules.admin.media.admin_background_audio_edit" %>
                    ...
                    <table border="0" cellspacing="0" cellpadding="4"> 
                           ...
                           <tr>
                            <td align="left" style="width:150px">
                                Portal</td>
                            <td align="left">                                
                               <asp:DropDownList ID="ddlPortalList" runat="server"></asp:DropDownList>  </td>
                        </tr>       
                           ...
                           <tr>
                               <td align="left" style="width:150px">
                                   Media Type</td>
                               <td align="left">
                                   <asp:DropDownList ID="ddlMediaTypeList" runat="server" ></asp:DropDownList>  </td>
                           </tr>
                           <tr>
                               <td align="left" style="width:150px">
                                   * Tiên bài hát</td>
                               <td align="left">
                                   <asp:TextBox ID="txtTitle" runat="server" ValidationGroup="ValidationCheck" 
                                       Width="300px"></asp:TextBox>
                                   <asp:RequiredFieldValidator ID="rfvTitle" runat="server" 
                                       ControlToValidate="txtTitle" Display="Dynamic" ErrorMessage="Not null" 
                         ...
                         <tr>
                             <td align="left" style="width:150px">
                                 * Chọn Audio File</td>
                             <td align="left">
                                 <asp:Literal ID="Literal_FileName" runat="server"></asp:Literal><br/>
                                 <asp:Literal ID="Literal_Preview" runat="server"></asp:Literal><br/>
                                     <input id="FileInput" type="file" runat="server"/>
                                     <asp:RegularExpressionValidator ID="revFileUpload" runat="server" 
                                    SetFocusOnError="True" ValidationExpression="^.*\.(mp3|wav|wmv)$"    
                                    ErrorMessage="InValid Extension" ValidationGroup="ValidationCheck" 
                                        ControlToValidate="FileInput" ForeColor="#FF3300"></asp:RegularExpressionValidator> 
                           ...
                           <tr>
                               ...
                               <td align="left">
                                    ...
                                    ValidationGroup="ValidationCheck" TextMode="MultiLine"></asp:TextBox>
                               </td>
                           </tr>

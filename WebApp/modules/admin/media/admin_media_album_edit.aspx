<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_media_album_edit.aspx.cs" Inherits="WebApp.modules.admin.media.admin_media_album_edit" %>
...
<head id="Head1" runat="server">
   ...
   <script type="text/javascript">
       function getbacktostepone() {
           window.location = "admin_media_album_edit.aspx";
       }
                ...
                <div class="popup_Container">
                    <div class="popup_Titlebar" id="PopupHeader">
                        <div class="TitlebarLeft">
                            Media Album: Cập Nhập Thông Tin                            
                         </div>
                                ...
                                <table border="0" cellspacing="0" cellpadding="4"> 
                                       ...
                                       <tr>
                                           <td align="left" style="width:150px">
                                               * Album Name</td>
                                           <td align="left">
                                               <asp:TextBox ID="txtAlbumName" runat="server" ValidationGroup="ValidationCheck" 
                                                   Width="300px"></asp:TextBox>
                                               <asp:RequiredFieldValidator ID="rfvAlbumName" runat="server" 
                                                   ControlToValidate="txtAlbumName" Display="Dynamic" ErrorMessage="Not null" 

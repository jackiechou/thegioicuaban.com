<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_media_artist_edit.aspx.cs" Inherits="WebApp.modules.admin.media.admin_media_artist_edit" %>
                                ...
                                <table border="0" cellspacing="0" cellpadding="4"> 
                                       ...
                                       <tr>
                                        <td align="left" style="width:150px">
                                            * Artist Name</td>
                                        <td align="left">                                
                                            <asp:TextBox ID="txtArtistName" runat="server" Width="300px" 
                                                ValidationGroup="ValidationCheck"></asp:TextBox>   
                                            <asp:RequiredFieldValidator ID="rfvArtistName" runat="server" ErrorMessage="Not null" 
                                                SetFocusOnError="True" ControlToValidate="txtArtistName" 

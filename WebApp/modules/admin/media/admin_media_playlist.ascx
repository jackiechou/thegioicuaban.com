<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="admin_media_playlist.ascx.cs" Inherits="WebApp.modules.admin.media.admin_media_playlist" %>
...
<div class="wrap_gp" >      
    ...
    <div class="group_panel">
            <asp:GridView ID="GridView1" DataKeyNames="PlayListId" runat="server" 
            ...
            <Columns>
                ...
                <EditItemTemplate>                                         
                    <asp:TextBox ID="txtIdx" runat="server" Text='<%# Bind("PlayListId") %>' Width="30px"></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:CheckBox ID="chkBxSelect" runat="server" />
                    <asp:HiddenField ID="hdnFldId" runat="server" Value='<%# Eval("PlayListId") %>' />
                </ItemTemplate>
                <HeaderTemplate>
                    <asp:CheckBox ID="chkBxHeader" onclick="javascript:HeaderClick(this);" runat="server" />
                </HeaderTemplate>
            </asp:TemplateField>                                      
                <asp:BoundField DataField="PlayListId" HeaderText="PlayListId" />
                <asp:BoundField DataField="PlayListName" HeaderText="PlayListName" />
               <asp:TemplateField HeaderText="FrontImage">
                    ...
                    <ItemTemplate>
                        <asp:Image ID="Image1" runat="server" 
                            ImageUrl='<%# Eval("FrontImage", "~/user_files/images/media_images/playlist_images/front_images/{0}") %>' />
                    </ItemTemplate>
                </asp:TemplateField>  
                <asp:BoundField DataField="TotalViews" HeaderText="TotalViews" />

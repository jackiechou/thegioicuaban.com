<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_media_composer_edit.aspx.cs" Inherits="WebApp.modules.admin.media.admin_media_composer_edit" %>
...
<head id="Head1" runat="server">
   ...
   <script type="text/javascript">
       function getbacktostepone() {
           window.location = "admin_media_composer_edit.aspx";
       }
                ...
                <div class="popup_Container">
                    <div class="popup_Titlebar" id="PopupHeader">
                        <div class="TitlebarLeft">
                            Media Composer: Cập Nhập Thông Tin                            
                         </div>
                                ...
                                <table border="0" cellspacing="0" cellpadding="4"> 
                                       ...
                                       <tr>
                                        <td align="left" style="width:150px">
                                            * Composer Name</td>
                                        <td align="left">                                
                                            <asp:TextBox ID="txtComposerName" runat="server" Width="300px" 
                                                ValidationGroup="ValidationCheck"></asp:TextBox>   
                                            <asp:RequiredFieldValidator ID="rfvComposerName" runat="server" ErrorMessage="Not null" 
                                                SetFocusOnError="True" ControlToValidate="txtComposerName" 

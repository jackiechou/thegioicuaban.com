<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="admin_media_album.ascx.cs" Inherits="WebApp.modules.admin.media.admin_media_album" %>
...
<div class="wrap_gp" >      
    ...
    <div class="group_panel">
            <asp:GridView ID="GridView1" DataKeyNames="AlbumId" runat="server" 
            ...
            <Columns>
                ...
                <EditItemTemplate>                                         
                    <asp:TextBox ID="txtIdx" runat="server" Text='<%# Bind("AlbumId") %>' Width="30px"></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:CheckBox ID="chkBxSelect" runat="server" />
                    <asp:HiddenField ID="hdnFldId" runat="server" Value='<%# Eval("AlbumId") %>' />
                </ItemTemplate>
                <HeaderTemplate>
                ...
                <asp:TemplateField HeaderText="FrontImage">
                    ...
                    <ItemTemplate>
                        <asp:Image ID="Image1" runat="server" 
                            ImageUrl='<%# Eval("FrontImage", "~/user_files/images/media_images/album_images/front_images/{0}") %>' />
                    </ItemTemplate>
                </asp:TemplateField>

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="admin_video.ascx.cs" Inherits="WebApp.modules.admin.media.admin_video" %>
...
<div class="wrap_gp" >      
    ...
    <div class="group_commands">       
            ...
            <div class="right">
                <div class="fillter_tool">
                    Type&nbsp;<asp:DropDownList ID="ddlMediaTypeList" runat="server" CssClass="combobox" 
                        onselectedindexchanged="ddlMediaTypeList_SelectedIndexChanged">
                    </asp:DropDownList>
                &nbsp; Topic:
                    <asp:DropDownList ID="ddlMediaTopicList" runat="server" CssClass="combobox" 
                        onselectedindexchanged="ddlMediaTopicList_SelectedIndexChanged">
                    </asp:DropDownList>
                &nbsp; Status:
    ...
    <div class="group_panel">
            ...
            AllowSorting="True" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" EmptyDataText="No Data"
                ...
                <asp:TemplateField ShowHeader="False">
                    <ItemTemplate>
                        <asp:ImageButton ID="btnDelete" runat="server" CausesValidation="false" 
                            CommandName="Delete" CommandArgument='<%# Bind("FileId") %>'  ImageUrl="~/images/icons/btnDelete.gif" Text="btnDelete" />
                    </ItemTemplate>
                </asp:TemplateField>  
            </Columns>

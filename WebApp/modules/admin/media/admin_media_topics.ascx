<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="admin_media_topics.ascx.cs" Inherits="WebApp.modules.admin.media.admin_media_topics" %>
...
<div class="wrap_gp" >      
    ...
    <div class="group_panel">
            <asp:GridView ID="GridView1" DataKeyNames="TopicId" runat="server" 
            ...
            <Columns>
                ...
                <EditItemTemplate>                                         
                    <asp:TextBox ID="txtIdx" runat="server" Text='<%# Bind("TopicId") %>' Width="30px"></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:CheckBox ID="chkBxSelect" runat="server" />
                    <asp:HiddenField ID="hdnFldId" runat="server" Value='<%# Eval("TopicId") %>' />
                </ItemTemplate>
                <HeaderTemplate>
                ...
                <asp:TemplateField ShowHeader="False">
                        <ItemTemplate>
                            <asp:ImageButton ID="btnDelete" runat="server" CausesValidation="false" 
                                CommandName="Delete" CommandArgument='<%# Bind("TopicId") %>'  ImageUrl="~/images/icons/btnDelete.gif" Text="btnDelete" />
                        </ItemTemplate>
                    </asp:TemplateField>    
            </Columns>

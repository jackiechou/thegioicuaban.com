...
{
    public partial class admin_media_artist : System.Web.UI.UserControl
    {
        protected static string add_url = "/modules/admin/media/admin_media_artist_edit.aspx?mode=add";
        protected static string edit_url = "/modules/admin/media/admin_media_artist_edit.aspx?mode=edit&idx=";
        protected static string loading_url = "/loading.aspx";

        private List<Media_Artists> StoredData
        {
            get { return ViewState["StoredData"] as List<Media_Artists> ?? null; }

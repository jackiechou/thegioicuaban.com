<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="admin_media_artist.ascx.cs" Inherits="WebApp.modules.admin.media.admin_media_artist" %>
...
<div class="wrap_gp" >      
    ...
    <div class="group_panel">
            <asp:GridView ID="GridView1" DataKeyNames="ArtistId" runat="server" 
            ...
            <Columns>
                ...
                <EditItemTemplate>                                         
                    <asp:TextBox ID="txtIdx" runat="server" Text='<%# Bind("ArtistId") %>' Width="30px"></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:CheckBox ID="chkBxSelect" runat="server" />
                    <asp:HiddenField ID="hdnFldId" runat="server" Value='<%# Eval("ArtistId") %>' />
                </ItemTemplate>
                <HeaderTemplate>
               ...
               <asp:TemplateField HeaderText="FrontImage">
                    ...
                    <ItemTemplate>
                        <asp:Image ID="Image1" runat="server" 
                            ImageUrl='<%# Eval("FrontImage", "~/user_files/images/media_images/artist_images/front_images/{0}") %>' />
                    </ItemTemplate>
                </asp:TemplateField>              

/**
 * $Id: editor_plugin_src.js 2 2008-04-10 13:09:46Z mohanjith $
 *
 * @author Mohanjith
 */
...
function init() {
var kkk=false;
if((support)&&(!isKHTML || is_safari || is_chrome)) {
...
// end AVIM JavaScript Vietnamese Input Method

(function() {
	// Load plugin specific language pack
	tinymce.PluginManager.requireLangPack('vietunicode');

	tinymce.create('tinymce.plugins.VietUnicode', {

		createControl: function(n, cm) {
			switch (n) {
				case 'vietunicode_method_listbox':
	                var mlb = cm.createListBox('vietunicode_method_listbox', {
	                     title : 'vietunicode.select_input_method',
	                     onselect : function(v) {
	                         setMethod(v);
	                     }
	                });
	                ...
	                mlb.add('vietunicode.off_desc', -1);
	                mlb.add('vietunicode.telex_desc', 1);
	                mlb.add('vietunicode.vni_desc', 2);
	                mlb.add('vietunicode.viqr_desc', 3);
	                mlb.add('vietunicode.auto_desc', 0);
		...
		getInfo : function() {
			return {
				longname : 'VietUnicode',
				author : 'S.H.Mohanjith',
				authorurl : 'http://mohanjith.com',
				infourl : 'http://mohanjith.com/2008/04/vietnamese-input-plugin-for-tinymce.html',
				version : '1.0'
			};
		}
	});
	...
	// Register plugin
	tinymce.PluginManager.add('vietunicode', tinymce.plugins.VietUnicode);
})();

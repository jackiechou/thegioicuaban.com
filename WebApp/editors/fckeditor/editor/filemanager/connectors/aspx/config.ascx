...
<script runat="server">
	...
	private bool CheckAuthentication()
	{
        ...
        //return false;
        //Cho phép nhập tin bài và duyệt tin bài truy cập trang
        /*
        if (Session["AdminURight"] == null)
        {
            return false;
        }
        else
	...
	public override void SetConfig()
	{
        ...
        Enabled = true;//CheckAuthentication();
		// URL path to user files.
		//UserFilesPath = "user_files/";
        //string str = Request.Url.ToString();
        string f = Request.QueryString["f"] == null ? "" : Request.QueryString["f"];
        if (f != "")
        {
            UserFilesPath = f;
            string fileFolder = Server.MapPath("~") + "\\" + f.Replace("/", "\\");
            ...
            UserFilesPath = "/" + ConfigurationManager.AppSettings["upload_file_dir"];
        //if (Request.Cookies["FCKInfo"]["MediaFolder"] != null)
        //{
        //    UserFilesPath = Request.Cookies["FCKInfo"]["MediaFolder"];
        //    string fileFolder = Server.MapPath("~") + "\\" + Request.Cookies["FCKInfo"]["MediaFolder"].ToString().Replace("/", "\\");
        //    if (!System.IO.Directory.Exists(fileFolder))
        //    {
        //        System.IO.Directory.CreateDirectory(fileFolder);
        //    }
        //}
        //else
        //    UserFilesPath = ConfigurationManager.AppSettings["WebHome"] + ConfigurationManager.AppSettings["WebMediaFolder"];
		...
		TypeConfig[ "File" ].FilesAbsolutePath			= ( UserFilesAbsolutePath == "" ? "" : "%UserFilesAbsolutePath%" );
		...
		TypeConfig[ "Flash" ].FilesAbsolutePath			= ( UserFilesAbsolutePath == "" ? "" : "%UserFilesAbsolutePath%" );
		...
		TypeConfig[ "Media" ].FilesAbsolutePath			= ( UserFilesAbsolutePath == "" ? "" : "%UserFilesAbsolutePath%" );

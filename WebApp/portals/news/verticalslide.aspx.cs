...
{
    public partial class verticalslide : System.Web.UI.Page
    {
                ...
                for (int i = 0; i < total; i += 2)
                {
                    ...
                    strHTML += "<div class=\"item\">"
                                       + "<div class=\"col_odd\" style=\"float:left; padding: 3px; border:1px solid #CCCCCC; margin-right: 5px;\">"
                                            + "<a href='" + NavigateUrl + "'><img src=\"" + path_image + "\" width=\"120px\" height=\"110px\" alt=\"" + dt.Rows[i]["Alias"].ToString() + "\" /></a>"
                                       + "</div>"
                                       + "<div class=\"col_even\" style=\"float:left; padding: 3px; border:1px solid #CCCCCC;\">"
                                            + "<a href='" + NavigateUrl1 + "'><img src=\"" + path_image1 + "\" width=\"120px\" height=\"110px\" alt=\"" + dt.Rows[i + 1]["Alias"].ToString() + "\" /></a>"
                                       + "</div>"
                                   + "</div>";
                }
            }

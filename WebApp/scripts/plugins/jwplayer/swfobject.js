...
deconcept.SWFObject = function (_1, id, w, h, _5, c, _7, _8, _9, _a) 
{
    ...
    this.skipDetect = deconcept.util.getRequestParameter(this.DETECT_KEY); this.params = new Object(); this.variables = new Object(); this.attributes = new Array(); if (_1) { this.setAttribute("swf", _1); } if (id) { this.setAttribute("id", id); } if (w) { this.setAttribute("width", w); } if (h) { this.setAttribute("height", h); } if (_5) { this.setAttribute("version", new deconcept.PlayerVersion(_5.toString().split("."))); } this.installedVer = deconcept.SWFObjectUtil.getPlayerVersion(); if (!window.opera && document.all && this.installedVer.major > 7) { deconcept.SWFObject.doPrepUnload = true; } if (c) { this.addParam("bgcolor", c); } var q = _7 ? _7 : "high"; this.addParam("quality", q); this.setAttribute("useExpressInstall", false); this.setAttribute("doExpressInstall", false); var _c = (_8) ? _8 : window.location; this.setAttribute("xiRedirectUrl", _c); this.setAttribute("redirectUrl", ""); if (_9) { this.setAttribute("redirectUrl", _9); }
};
...
deconcept.SWFObject.prototype = {
    ...
    getSWFHTML: function () {
        ...
        if (navigator.plugins && navigator.mimeTypes && navigator.mimeTypes.length) 
        {
            ...
            _19 = "<embed type=\"application/x-shockwave-flash\" bgcolor=\"#ffffff\" loop=\"false\" hidden=\"false\" quality=\"high\" wmode=\"transparent\" allowfullscreen=\"true\" allowscripaccess=\"never\" allowNetworking=\"internal\" enableJavaScript=\"false\"  ShowStatusBar=\"1\" volume=\"50\" src=\"" + this.getAttribute("swf")
            ...
            _19 += "<param name=\"quality\" value=\"high\">";
            _19 += "<param name=\"wmode\" value=\"transparent\">";
            _19 += "<param name=\"bgcolor\" value=\"#ffffff\">";
            _19 += "<param name=\"allowScriptAccess\" value=\"never\">";
            _19 += "<param name=\"allowNetworking\" value=\"internal\">";
